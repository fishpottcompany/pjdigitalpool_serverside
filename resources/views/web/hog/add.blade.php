        ...
        <div class="row">
            <div class="col-xl-12 box-margin height-card">
                <div class="card card-body">
                    <h4 class="card-title">Add HOG</h4>
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <form id="form"  enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="hog_file">Report PDF File</label>
                                    <input type="file" required id="article_pdf" name="article_pdf"  accept=".pdf" class="form-control">
                                </div>
...
<!-- CUSTOMJS -->
<script src="/js/custom/web/hog/hog.js"></script>
@endsection