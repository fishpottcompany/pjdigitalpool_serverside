...
<!-- Mirrored from demo.riktheme.com/antina/side-menu/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Aug 2020 10:06:11 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <!-- Title -->
    <title>Admin: PJ Digital Pool</title>
    ...
    <script src="/js/custom/web/login/auth.js"></script>
...
<span id="msg_holder"></span>
                    ...
                    <div class="middle-box">
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <!-- Logo -->
                                <h4 class="font-24 mb-30">Admin Login.</h4>
                                <div class="d-flex justify-content-center">
                                    <div id="loader" class="customloader" style="display: none;"></div>
                                </div> 
                                <form id="form">
                                    <div class="form-group">
                                        <input class="form-control login" type="text" name="user_phone_number" id="admin_phone_number" required="" placeholder="Enter phone number">
                                    </div>
    ...
    ********* Page Wrapper Area End ***********
    ...
    <!-- CUSTOMJS -->
    <script src="/js/custom/web/login/login.js"></script>
