        ...
        <div class="row">
            <div class="col-xl-12 box-margin height-card">
                <div class="card card-body">
                    <h4 class="card-title">Delete Audio</h4>
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <form id="delete_form"  enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="audio_id">Audio ID</label>
                                    <input type="number" required min="0" id="audio_id" name="audio_id" class="form-control" placeholder="Enter Audio ID">
                                </div>
